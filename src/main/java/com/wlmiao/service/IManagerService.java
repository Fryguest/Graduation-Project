...
public interface IManagerService {
    ...
    void downloadTeacher(String instituteNo, HttpServletResponse response) throws EduSysException;
    ...
    void distributionTeacher(String teacherList, String majorNo, String grade, Boolean random,
        HttpServletResponse response) throws EduSysException;
